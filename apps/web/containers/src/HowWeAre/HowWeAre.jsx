        ...
        <Container>
          <div className=" relative">
            ...
            <div className=" lg:h-[392px] lg:flex lg:mx-auto">
              <div className=" flex w-fit pt-6 lg:pt-0 mb-12 mx-auto lg:my-auto" >
                <img 
                src="Group45.png" 
              ...
              <div className="w-fit mx-auto lg:mr-auto lg:my-auto">
                <div className=" text-left lg:w-[537px]">
                  <h3 
                  className=" text-white text-2xl font-semibold font-barlown ml-[16px] mb-[24px] lg:ml-0"
            ...
            <div className=" lg:h-[568px] grid grid-cols-1">
              <h3 
