      ...
      <div className=" w-full bg-rich-black relative">
        <Container>
          <div className=" relative">
            <div className=" absolute top-[49px] left-[22px] hidden xl:block">
              <img src="Group23.svg" />
            </div>
            <div className=" lg:h-[392px] lg:flex lg:mx-auto">
              ...
              <div className="w-fit mx-auto lg:mr-auto lg:my-auto">
                <div className=" text-left lg:w-[537px]">
                  <h3 className=" text-white text-2xl font-semibold font-barlown ml-[16px] mb-[24px] leading-[28.8px] lg:ml-0">
                    ¿Qué es
                    <span className=" text-caquelicot text-3xl font-extrabold mb-2 leading-[28.8px]">
                      {" "}
                      Kodify
                    </span>
                    ?
            ...
            <div className=" grid grid-cols-1 lg:h-[568px]">
              <h3 className=" text-white mx-auto text-2xl font-semibold font-barlow mb-[24px] leading-[38.4x] lg:text-3xl">
                Nuestro equipo
              </h3>
              <img
              ...
              />
              <p className=" text-white font-normal text-[14px] font-barlow mx-auto mb-[24px] leading-[21.6px] lg:text-[18px]">
