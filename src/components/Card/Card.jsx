                     ...
                     <section key={data.id} className="group [perspective:1000px]">
                        ...
                        >
                           ...
                           <div className="relative inset-0">
                              <img className="mx-auto w-[50px] h-[50px]" src={data.img.flip} alt={data.imgAlt.flip} />
                              <div className="w-[195px] h-[76px] text-center mt-3">
                                 <h2 className="text-3xl font-bold leading-leading-title">{data.title}</h2>
                              </div>
                           </div>
                           ...
                           >
                              <div className="flex flex-col items-center justify-center">
                                 <img className="mx-auto w-[50px] h-[50px]" src={data.img.base} alt={data.imgAlt.base} />
